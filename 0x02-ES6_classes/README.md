ES6 CLASSES: UNDERSTANDING HOW TO DEFINE CLASSES,ADD METHODS TO CLASSES,ADD STATIC METHODS,EXTEND CLASSES FROM ANOTHER AND PERFORMING METAPROGRAMING SYMBOLS
